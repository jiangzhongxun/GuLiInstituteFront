...
export default {
    // 异步调用, 调用一次 asyncData({params, error}) {}
    // params: 相当于之前 this.$route.params;   this.$route.params.id 等价 params.id
    asyncData({params, error}) {
        return teacherApi.getTeacherFrontInfo(params.id).then(response => {
            return {
